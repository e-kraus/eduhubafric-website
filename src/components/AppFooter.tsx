  ...
  <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      ...
      <a href="/" className="text-3xl font-bold font-heading">
        ...
        We are an education social enterprise for Africa focused, STEM/education interventions and research.
        </p>
      ...
      <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            <a className="hover:opacity-75" href="/about-us"> About </a>
            <a className="hover:opacity-75" href="/"> Our Programs </a>
            <a className="hover:opacity-75" href="/our-team"> Meet the Team </a>
            {/* <a className="hover:opacity-75" href="/"> Background </a> */}
          </nav>
        </div>
        <div>
          <p className="font-medium">
        ...
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            <a className="hover:opacity-75" href="/contact-us"> Contact </a>
            <a className="hover:opacity-75" href="/faq"> FAQs </a>
            <a className="hover:opacity-75" href="/subscribe-newsletter"> Subscribe to our newsletter </a>
          </nav>
        </div>
        <div>
          <p className="font-medium">
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            <a className="hover:opacity-75" href="/legal/privacy-policy"> Privacy Policy </a>
            <a className="hover:opacity-75" href="/legal/terms-of-use"> Terms &amp; Conditions </a>
            <a className="hover:opacity-75" href="/legal/cookie-policy"> Cookies Policy </a>
          </nav>
        </div>
      </div>
    </div>
