            ...
            <div className="lg:w-1/2 lg:mx-6">
              ...
              <div className="mt-6 space-y-8 md:mt-8">
                <p className="flex items-start -mx-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-purple-500 dark:text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <p className="flex items-start -mx-2">
                  ...
                  <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">name@mail.com</span>
                </p>
              </div>
              ...
              <div className="mt-6 w-80 md:mt-8">
                ...
                <div className="flex mt-4 -mx-1.5 ">
                  <a href="/" className="mx-1.5 dark:hover:text-purple-400 text-gray-400 transition-colors duration-300 transform hover:text-purple-500" >
              ...
              <div
                ...
                <form className="mt-6">
                  ...
                  <div className="w-full mt-6">
                    ...
                    <textarea className="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-48 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-purple-400 dark:focus:border-purple-400 focus:ring-purple-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Message"></textarea>
                  </div>
